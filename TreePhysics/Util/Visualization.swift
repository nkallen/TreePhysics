...
public func createAxesNode(quiverLength: Float, quiverThickness: Float) -> SCNNode {
    ...
    xQuiverNode.simdPosition = simd_float3(quiverLength / 2.0, 0.0, 0.0)
    ...
    yQuiverNode.simdPosition = simd_float3(0.0, quiverLength / 2.0, 0.0)
    ...
    zQuiverNode.simdPosition = simd_float3(0.0, 0.0, quiverLength / 2.0)
